                ...
                with st.spinner("🧠 Frontier model evaluating compiled context layers..."):
                    try:
                        ...
                        prompt = (
                            ...
                            f"CRITICAL RULES FOR MATRIX STATUS EVALUATION:\n"
                            f"- For 'Object Architectural Type', evaluate strictly if the IFC Class (e.g., IfcWall) is the correct high-level schema container for the element. If it represents a wall, mark it COMPLIANT at the schema level.\n"
                            f"- For 'Construction Assembly Type', evaluate the construction methodology implied by the Object Name/Type (e.g., SIP vs. Masonry Cavity) against the specification requirements. This is where physical assembly clashes belong.\n"
                            f"- Keep the descriptions in the 'Spec Target' column highly concise (maximum 1-2 short sentences) to ensure proper text-wrapping.\n\n"
